...
def azurecloud(primaryName, cname):
    try:
        dns.resolver.query(cname)
    except:
        print(bcolors.FAIL + "Possble takeover of {} with CNAME {}".format(primaryName, cname) + bcolors.ENDC)

def azuretraffic(primaryName, cname):
    try:
        dns.resolver.query(cname)
    except:
        print(bcolors.FAIL + "Possble takeover of {} with CNAME {}".format(primaryName, cname) + bcolors.ENDC)

def azurecdn(primaryName, cname):
    try:
        dns.resolver.query(cname)
    except:
        print(bcolors.FAIL + "Possble takeover of {} with CNAME {}".format(primaryName, cname) + bcolors.ENDC)

def azureapi(primaryName, cname):
    try:
        dns.resolver.query(cname)
    except:
        print(bcolors.FAIL + "Possble takeover of {} with CNAME {}".format(primaryName, cname) + bcolors.ENDC)

def azureservice(primaryName, cname):
    try:
        dns.resolver.query(cname)
    except:
        print(bcolors.FAIL + "Possble takeover of {} with CNAME {}".format(primaryName, cname) + bcolors.ENDC)
...
domains= {
	...
	azurewebsites : 'azurewebsites.net',
    	azurecloud : 'cloudapp.net',
   	azuretraffic : 'traffimanager.net',
    	azurecdn : 'azureedge.net',
    	azureapi : 'azure-api.net',
    	azureservice : 'p.azurewebsites.net',
